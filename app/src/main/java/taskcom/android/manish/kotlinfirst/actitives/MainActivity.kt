...
class MainActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        btnHobbies.setOnClickListener {
            ...
            showToast("${resources.getString(R.string.hobbies)}", Toast.LENGTH_LONG)
            val hobbiesIntent = Intent(this, HobbiesActivity::class.java)
            hobbiesIntent.putExtra(AppConstants.USER_MESSAGE_KEY, "${resources.getString(R.string.my_name)}")
